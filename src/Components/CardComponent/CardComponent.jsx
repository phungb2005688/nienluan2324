...
import { StyleNameProduct, WrapperCardStyle, WrapperTextDiscount, WrapperTextPrice, WrapperTextReport } from './style'
import {
    StarFilled
        ...
        >
            ...
            <WrapperTextReport>
                <span style={{marginRight: '7px'}}>
                    <span>4.96</span> <StarFilled style={{ fontSize: '12px', gap: '5px', color: '#faad14'}}/>
                </span>
                <span>|</span>
